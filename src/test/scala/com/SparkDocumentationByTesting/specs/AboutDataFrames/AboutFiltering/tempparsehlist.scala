...
object tempparsehlist extends App {
	...
	val lst: Seq[Animal] = List(Animal.Rodent.Squirrel, Animal.SeaCreature.Dolphin, Animal.Bird.Eagle.GoldenEagle, Animal.Cat.DomesticCat.SiameseCat, Animal.Canine.WildCanine.Hyena, Animal.SeaCreature.Oyster)
