...
class InnerJoinSpecsRunner extends AnyFunSpec with Matchers with MySharedSparkContext {
	...
	// take place?
	val ij_convertStrColToInt = InnerJoinSpecs[String, Int, Int](empDF_strCol, deptDF, leftColname,
	...
	val ij_keepColAsInt = InnerJoinSpecs[Int, Int, Int](empDF_intCol, deptDF, leftColname,
	...
	val ij_convertColToStr = InnerJoinSpecs[String, Int, String](empDF_strCol, deptDF, leftColname,
		StringType, rightColname, IntegerType)
