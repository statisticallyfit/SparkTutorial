		...
		object fromEnums {
			...
			object AnimalDf {
				...
				val animalSeq: Seq[(Animal, Amount, World, ClimateZone, Biome)] = Seq(
					...
					(Animal.Camelid.Camel, 29, Arabia.UnitedArabEmirates, ClimateZone.Desert, Biome.Desert), Biome.Desert,
					...
					(_, 11, France.Lyon, ClimateZone.Mediterranean, Biome.Grassland.Shrubland),

					(Animal.Cat.WildCat.Lion, 12, Africa.Libya, ClimateZone.Tundra),
					(Animal.Giraffe, 1, Africa.Algeria, ClimateZone.Tundra),
					(Animal.Hippo, 10, Africa, ClimateZone.Tundra),
					(Animal.Bear.Koala, 120, Australia, ClimateZone.Tundra),
					(Animal.Cat.WildCat.Lynx, 12, Russia.Khabarovsk, ClimateZone.Tundra),
					(Animal.Bird.Hawk, 12, Russia.Murmansk, ClimateZone.Tundra),
					(Animal.Bird.Eagle.GoldenEagle, 12, UnitedStates, ClimateZone.Tundra),
					(_, 14, Canada.Yukon, ClimateZone.Tundra),
					(_, 23, Canada.Nunavut, ClimateZone.Tundra),
					(_, 3, Canada.BritishColumbia, ClimateZone.Tundra),
					(_, 4, Russia.Sochi, ClimateZone.Tundra),
					(_, 5, Russia.Volgograd, ClimateZone.Tundra),
					(_, 8, Russia.Tobolsk, ClimateZone.Tundra),
					(_, 90, Russia.Kalingrad, ClimateZone.Tundra),
					(_, 10, Russia.Ufa, ClimateZone.Tundra),
					(_, 11, Russia, ClimateZone.Tundra),

					(Animal.Rodent.Squirrel.Marmot, 120, UnitedStates, ClimateZone.Continental),
					(_, 63, Canada.Manitoba, ClimateZone.Continental),
					(_, 90, Canada.Alberta, ClimateZone.Continental),
					(_, 73, Canada.BritishColumbia, ClimateZone.Continental),
					(_, 12, UnitedStates.Michigan, ClimateZone.Continental),
					(_, 18, UnitedStates.Pennsylvania, ClimateZone.Continental),
					(_, 77, UnitedStates.Maine, ClimateZone.Continental),
					(_, 3, Canada.Ontario, ClimateZone.Continental),
					(_, 4, Canada.Quebec, ClimateZone.Continental),
					(_, 78, Poland, ClimateZone.Continental),
					(_, 90, Hungary, ClimateZone.Continental),
					(_, 8, Serbia, ClimateZone.Continental),
					(_, 8, Slovakia, ClimateZone.Continental),
					(_, 8, Czechia, ClimateZone.Continental),
					(_, 8, Croatia, ClimateZone.Continental),
					(_, 8, Romania, ClimateZone.Continental),
					(_, 8, Moldova, ClimateZone.Continental),
					(_, 8, Lithuania, ClimateZone.Continental),
					(_, 8, Latvia, ClimateZone.Continental),
					(_, 8, Liechtenstein, ClimateZone.Continental),
					(_, 8, Luxembourg, ClimateZone.Continental),
					(_, 8, Switzerland, ClimateZone.Continental),
					(_, 8, Ukraine, ClimateZone.Continental),
					(_, 8, Hungary, ClimateZone.Continental),
					(_, 8, Bulgaria, ClimateZone.Continental),

					(Animal.Camelid.Llama, 4, Chile, ClimateZone.MountainHighland),
					(Animal.Camelid.Llama, 3, Colombia, ClimateZone.MountainHighland),
					(Animal.Camelid.Llama, 13, Honduras, ClimateZone.MountainHighland),
					(Animal.Camelid.Llama, 32, Ecuador, ClimateZone.MountainHighland),
					(Animal.Camelid.Alpaca, 23, Bolivia, ClimateZone.MountainHighland),
					(Animal.Camelid.Alpaca, 30, Peru, ClimateZone.MountainHighland),
					(_, 93, UnitedStates.Kansas, ClimateZone.MountainHighland),
					(_, 45, UnitedStates.Colorado, ClimateZone.MountainHighland),
					(_, 8, UnitedStates.Texas, ClimateZone.MountainHighland),
					(_, 7, UnitedStates.Utah, ClimateZone.MountainHighland),
					(_, 58, UnitedStates.Nevada, ClimateZone.MountainHighland),
					(_, 89, Canada.BritishColumbia, ClimateZone.MountainHighland),
					(_, 5, China, ClimateZone.MountainHighland),

					(Animal.Bear, 14, Canada, ClimateZone.Temperate),
					(Animal.Bear, 11, Russia.Omsk, ClimateZone.Temperate),
					(_, 3, Russia.SaintPetersburg, ClimateZone.Temperate),
					(_, 4, Russia.Kazan, ClimateZone.Temperate),
					(Animal.WeaselMustelid.Weasel, 21, Canada, ClimateZone.Temperate),
					(Animal.Deer.Reindeer, 41, Canada, ClimateZone.Temperate),
					(Animal.Rodent.Squirrel, 44, Canada, ClimateZone.Temperate),
					(Animal.Canine.WildCanine.Fox, 43, Russia.Smolensk, ClimateZone.Temperate),
					(Animal.Canine.WildCanine.Fox, 42, Canada.Quebec, ClimateZone.Temperate),
					(Animal.Rabbit, 120, UnitedStates, ClimateZone.Temperate),
					(Animal.Cat.DomesticCat.SiameseCat, 8, China, ClimateZone.Temperate),
					(Animal.Cat.DomesticCat.ShorthairedCat, 12, UnitedStates, ClimateZone.Temperate),
					(Animal.Bird.Sparrow, 12, France, ClimateZone.Temperate),
					(Animal.Bird.Sparrow, 12, Ireland, ClimateZone.Temperate),
					(Animal.Bird.Sparrow, 12, Scotland, ClimateZone.Temperate),
					(_, 115, Spain, ClimateZone.Temperate),
					(_, 16, Spain, ClimateZone.Temperate),
					(_, 113, France, ClimateZone.Temperate),
					(_, 67, Italy, ClimateZone.Temperate),
					(_, 87, Italy.ApenninePeninsula.PapalStates.Rome, ClimateZone.Temperate),
					(_, 10, Greece, ClimateZone.Temperate),
					(_, 4, Norway, ClimateZone.Temperate),

					(Animal.Bear, 120, Russia.Sarov, ClimateZone.Arctic),
					(_, 4, Russia.Alexandrov, ClimateZone.Arctic),
					(Animal.Bear, 190, Canada.Yukon, ClimateZone.Arctic),
					(Animal.Canine.WildCanine.Fox, 120, Russia.Derbent, ClimateZone.Arctic),
					(Animal.Canine.WildCanine.Fox, 160, Canada.NorthwestTerritories, ClimateZone.Arctic),
					(Animal.Cat.WildCat.Cougar, 1, Russia.Yekaterinburg, ClimateZone.Arctic),
					(Animal.Bird.Sparrow, 2, Canada.NovaScotia, ClimateZone.Arctic),
					(_, 5, Russia.Moscow, ClimateZone.Arctic),
					(_, 4, Russia.NizhnyNovgorod, ClimateZone.Arctic),
					(_, 5, Greenland, ClimateZone.Arctic),
					(_, 8, Iceland, ClimateZone.Arctic),
					(_, 3, Antarctica, ClimateZone.Arctic),
					(_, 9, Antarctica, ClimateZone.Arctic),
					(_, 312, Antarctica, ClimateZone.Arctic),
					(_, 678, UnitedStates.Alaska, ClimateZone.Arctic),
					(_, 13, Sweden, ClimateZone.Arctic),
					(_, 12, Norway, ClimateZone.Arctic),
					(_, 3, Finland, ClimateZone.Arctic),
